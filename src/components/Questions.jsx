...
function Questions() {
  ...
  return (
    ...
    <div className='mt-60 text-center mb-20 relative'>
        ...
        <div className=' sm:w-[90%] 2xl:w-[50%]'>
...
<div className='sm:hidden 2xl:inline absolute xl:right-6 2xl:right-20 4xl:right-60 bottom-0'>
  <div className='flex'>
...
<div className='2xl:inline absolute sm:hidden xl:left-4 xl:top-[-4%] 2xl:left-20 4xl:left-60 top-0'>
  <div className='flex'>
